...
# «Вал» — полноценный тип улицы в Москве: Хамовнический, Земляной, Крымский.
# Без него адрес карточки ЕИСЖС не разбирался, и проект уходил в карантин.
_STREET = (
    r"(?:ул\.?|улица|проспект|пр-т|просп\.?|проезд|шоссе|ш\.|наб\.?|набережная|"
    r"переулок|пер\.?|бульвар|б-р|аллея|линия|тупик|вал|площадь|пл\.?|просек|тракт)"
)
