...
app = FastAPI(title="PLATO Development Investment Model", version="0.12.5")
...
@app.get("/health")
def health() -> dict:
    return {"status": "ok", "version": "0.12.5"}
...
def _openai_responses_request(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "PLATO-Development-Model/0.12.5",
        },
        method="POST",
    )
    try:
...
<div class="shell">
  ...
  <div class="header">
    <div class="title"><h1>Девелоперская инвестиционная модель</h1><p>v0.12.5 · ТЭП · экономика · БРИДЖ · проектное финансирование · эскроу · LLCR</p></div>
    <div class="actions">
