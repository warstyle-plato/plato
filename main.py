...
app = FastAPI(title="PLATO Development Investment Model", version="0.12.1")
...
def _openai_responses_request(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "PLATO-Development-Model/0.12.1",
        },
        method="POST",
    )
    try:
...
<div class="shell">
  ...
  <div class="header">
    <div class="title"><h1>Девелоперская инвестиционная модель</h1><p>v0.12.1 · ТЭП · экономика · БРИДЖ · проектное финансирование · эскроу · LLCR</p></div>
    <div class="actions">
  ...
  <div style="margin:0 24px 10px;padding:10px 13px;border:1px solid #ddd;background:#fafaf8;font-size:11px;line-height:1.5;color:#555">
    <b>Пресеты класса и сценария.</b>
    Класс проекта задаёт <b>базовые</b> цены и базовую строительную себестоимость:
