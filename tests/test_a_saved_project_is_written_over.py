...
Теперь три названные двери — «Сохранить» в шапке, «Сохранить как…» и «Сохранить»
в строке списка, — и все три ведут в один `storeProject`.
...
def test_a_row_is_written_over_without_opening_it() -> None:
    """Кнопка строки списка: открывать проект ради записи в него незачем."""
