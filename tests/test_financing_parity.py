...
Методика лимита — решение владельца (04.08.2026): капитализация процентов
лимит ПФ не выбирает и не уменьшает. Лимит покрывает только тело долга,
payable живёт вне лимита; плата за невыбранный лимит — от «лимит минус
тело». «Превышение лимита», найденное сложением payable с телом, — ошибка
сверки, а не модели.
...
def test_the_fee_defaults_follow_the_credit_agreements():
    ...
    Плата за пользование лимитом в договорах — 0,7% годовых в двух из
    пяти и 1% ещё в двух; модель держит нижнюю границу 0,7%, прежние 0,5%
    занижали комиссии в полтора раза. Плата за резервирование — 0,1% от
    максимального лимита; прежние
