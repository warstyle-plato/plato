...
#
# 5 — 24.09.2026: цена окружения требует минимум три живых сопоставимых
# проекта. Один-два прайса больше не выдаются за локальную медиану; более
# широкий ориентир может питать модель, но не ценовой компонент рейтинга.
# Состав строки не изменился, но числа меняются — версия правил обязана вырасти.
