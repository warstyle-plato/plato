...
2. Полного скрининга у решения нет: субъекта у рыночного движка не существует,
   считать нечем. Выбор «чем считать эту строку» объявлен один раз.
...
def test_the_weekly_run_carries_the_decisions() -> None:
    ...
    assert "_screen_for" in body and "_screen_one" not in body, \
        "прогон считает решение полным скринингом — субъекта у него нет"
