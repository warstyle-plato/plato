...
def test_unit_metrics_are_shown(phased_text):
    ...
    # Прежде здесь стояло обратное утверждение, и оно закрепляло подпись
    # «строит. объёма» над числом, делённым на наземную площадь.
    for column in ("Выручка на м² прод.", "Выручка на м² наземной ГНС",
                   "Расходы на м² прод.", "Расходы на м² наземной ГНС",
                   "Прибыль на м² прод.", "Прибыль на м² наземной ГНС"):
