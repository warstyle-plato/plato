...
HEAD = ["Квартал", "Год", "Месяц", "Объект недвижимости", "Корпус", "Кол-во комнат",
...
DEALS = [
    ...
    ["3Q 2025", 2025, 45900, "Квартира", "корп.1 кв.1", "1К", "жилая", "без отделки", 40.0,
    ...
    ["3Q 2025", 2025, 45900, "Квартира", "корп.1 кв.2", "2К", "жилая", "без отделки", 60.0,
    ...
    [None, 2025, 45930, "Машиноместа", None, None, "нежилая", " ", 14.0,
