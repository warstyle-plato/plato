...
# Останавливаем прежний стенд до закрытой пробы: так на небольшой ВМ не живут
# одновременно старые два воркера и новый preview. При любой ошибке он вернётся.
