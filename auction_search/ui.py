...
__DEVELOPAID_CONTOUR__
  <div id="krtPanel" class="hidden">
    <div class="filters wide">
      ...
      <input id="krtMinSales" type="number" min="0" step="50" value="600" placeholder="Продажи окружения от"
             title="Текущая оценка продаж окружения из того же рыночного отчёта / Пульса продаж, которым считается скрининг КРТ. По умолчанию показываются площадки строго выше 600. Нет данных — отдельный ответ, такие строки при пороге скрыты.">
