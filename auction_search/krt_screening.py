...
#
# 5 — 24.09.2026: КРТ больше не подменяется ближайшим ЖК при совпадении
# координат. Цена окружения считается вокруг территории по её официальному
# центру/контуру. Старые строки обязаны пересчитаться: именно в них сохранились
# аномальные 2,6–3,2 млн ₽/м², полученные от чужого проекта.
