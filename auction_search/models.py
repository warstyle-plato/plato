...
class LotKind(str, Enum):
    ...
    # Продажа доли в обществе. Не разновидность имущественного комплекса:
    # покупают ОБЩЕСТВО вместе с его обязательствами и историей, а не объект.
    # Сроки, риск и проверка у такой сделки другие, и подписывать две разные
    # сделки одним именем нельзя. До 01.09.2026 доля со словом «здание» рядом
    # опознавалась имущественным комплексом, а без него — «прочим».
