...
async function boot(){
 let cat=await j('/krt-preview/data'), rows=cat.sites||cat.rows||cat.items||cat.krt||[], r=rows.find(x=>String(x.slug||'')===slug)||{};
