...
function siteMap(site,row,full,marketPoint,rank){
 ...
 if(!pts.length){box.innerHTML='<div class="box"><b>Карта пока не получена</b><br>Контур КРТ или геометрия участков не пришли из рабочего источника. Остальные блоки карточки продолжают работать.</div>';return}
