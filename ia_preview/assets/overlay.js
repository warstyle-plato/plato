...
(function () {
  ...
  /* Рынок стоит в экономике перед вводными, а не после: цену квартир берут с
     рынка, а не назначают и потом сверяют. Комментарии живут снаружи массива —
     сверка разделов с вкладками страницы читает его как JSON. */
  var SECTIONS = [
    { id: 'project', label: 'Проект', tabs: ['iaSite', 'tep', 'phasing'] },
    { id: 'economics', label: 'Экономика', tabs: ['marketDiscovery', 'inputs', 'vri', 'rates'] },
