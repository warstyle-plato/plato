...
Машинные правила ниже пока воспроизводят постановление Правительства Московской
области от 02.07.2026 № 774-ПП. В нормативном аудите 19.09.2026 обнаружена
более новая поправка — ПП МО от 01.09.2026 № 1080-ПП. До построчной миграции
правил справочник считается требующим ревизии; использовать 774-ПП как
«последнюю редакцию» нельзя.
"""
...
def reference_status() -> dict[str, Any]:
    ...
    return {
        ...
        "newer_amendment": "ПП МО от 01.09.2026 № 1080-ПП",
        "effective_from": PP_774["effective_from"],
...
VERIFIED_FROM = "аудиту редакций: обнаружено 1080-ПП; машинные правила пока по 774-ПП"
